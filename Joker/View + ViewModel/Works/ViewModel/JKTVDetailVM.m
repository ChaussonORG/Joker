...
@interface JKTVDetailVM()<WorkrefreshSuperTableViewDelegate,CHLoginModalControllerDelegate>
...
- (void)requestData{
    ...
    [api startWithSuccessBlock:^(__kindof JKTVDetailApi *request) {
        ...
        if (self.imageArrs.count%4 == 0) {
            self.imagesCellHeight =(self.imageArrs.count/4 )*((ScreenWidth - 35)/4) +36;
        }
        else{

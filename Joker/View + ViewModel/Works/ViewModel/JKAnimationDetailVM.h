...
typedef NS_ENUM(NSInteger, JKAnimationDataFilter){
    JKAnimationDataInfo,
    JKAnimationDataComment,
    JKAnimationDataTopic,
};


@protocol AnimationrefreshTableViewDelegate <NSObject>

- (void)tableViewReload;

@end

@interface JKAnimationDetailVM : NSObject
@property (nonatomic , weak) id<AnimationrefreshTableViewDelegate>delegate;

@property (nonatomic , assign) JKAnimationDataFilter filterType;

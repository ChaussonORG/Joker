...
typedef NS_ENUM(NSInteger, JKGameDataFilter){
    JKGameDataInfo,
    JKGameDataComment,
    JKGameDataTopic,
};
...
@protocol GamerefreshTableViewDelegate <NSObject>

- (void)tableViewReload;

@end

@interface JKGameDetailVM : NSObject
@property (nonatomic , weak) id<GamerefreshTableViewDelegate>delegate;

@property (nonatomic , assign) JKGameDataFilter filterType;

...
typedef NS_ENUM(NSInteger, JKVarietyDataFilter){
    JKVarietyDataInfo,
    JKVarietyDataComment,
    JKVarietyDataTopic,
};


@protocol VarietyrefreshTableViewDelegate <NSObject>

- (void)tableViewReload;

@end

@interface JKVarietyDetailVM : NSObject
@property (nonatomic , weak) id<VarietyrefreshTableViewDelegate>delegate;

@property (nonatomic , assign) JKVarietyDataFilter filterType;

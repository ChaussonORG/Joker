...
@interface JKTVDetailController ()<UITableViewDelegate,UITableViewDataSource,ChooseTopicDelegate,TopicCommentDelegate,PhotoBroswerVCDelegate,TVrefreshTableViewDelegate,CHLoginModalControllerDelegate>
...
@implementation JKTVDetailController
...
- (instancetype)initWithWorkId:(NSString *)workId
{
    ...
    if (self) {
        ...
        self.viewModel = [[JKTVDetailVM alloc]initWithWorkId:workId];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section{
    ...
    if (self.viewModel.filterType == JKTVDataInfo) {
        
        return 3;
    }
    else if (self.viewModel.filterType == JKTVDataComment ) {
...
- (void)chooseTopicWithIndex:(NSInteger)index{
    ...
    if (index == 0) {
        ...
        self.viewModel.filterType = JKTVDataInfo;
        self.createTopicBtn.hidden = YES;
    }
    else if (index == 1) {
        
        self.viewModel.filterType = JKTVDataComment;
        self.createTopicBtn.hidden = YES;
    }
    else{
        
        self.viewModel.filterType = JKTVDataTopic;

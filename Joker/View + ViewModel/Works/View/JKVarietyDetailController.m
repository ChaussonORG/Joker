...
@interface JKVarietyDetailController ()<UITableViewDelegate,UITableViewDataSource,ChooseTopicDelegate,TopicCommentDelegate,PhotoBroswerVCDelegate,VarietyrefreshTableViewDelegate,CHLoginModalControllerDelegate>
...
@property (nonatomic , strong) PhotoCotentView *contenVarietyiew;
...
- (instancetype)initWithWorkId:(NSString *)workId
{
    ...
    if (self) {
        ...
        self.viewModel = [[JKVarietyDetailVM alloc]initWithWorkId:workId];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section{
    ...
    if (self.viewModel.filterType == JKVarietyDataInfo) {
        
        return 3;
    }
    else if (self.viewModel.filterType == JKVarietyDataComment ) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (self.viewModel.filterType == JKVarietyDataInfo) {
        ...
        if (indexPath.row == 0) {
            ...
            self.contenVarietyiew = cell.contentImageView;
...
-(void)networkImageShow:(NSUInteger)index{
    ...
    [PhotoBroswerVC show:self type:PhotoBroswerVCTypeZoom index:index photoModelBlock:^NSArray *{
        ...
        for (NSUInteger i = 0; i< networkImages.count; i++) {
            ...
            //源frame
            UIImageView *imageV =(UIImageView *) weakSelf.contenVarietyiew.subviews[i];

...
@interface JKVarietyTimeLineController ()<UITableViewDelegate,UITableViewDataSource,ChooseTopicDelegate>
...
@implementation JKVarietyTimeLineController
- (instancetype)init
{
    self = [super init];
    if (self) {
        
        self.viewModel = [[JKVarietyTimeLineVM alloc]init];
    }
    return self;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    JKVarietyTimelineCell *cell = [tableView dequeueReusableCellWithIdentifier:cellId];
    if (cell == nil) {
        cell = [[JKVarietyTimelineCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellId];
    }

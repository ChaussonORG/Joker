...
@implementation JKAnimationTimelineCell
...
- (void)setUpSubViews{
    ...
    [_collectionView registerClass:[JKAnimationTimeLineCollectionViewCell class] forCellWithReuseIdentifier:@"UICollectionViewCell"];
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    JKAnimationTimeLineCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:cellIdentifier forIndexPath:indexPath];
